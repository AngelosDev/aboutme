        ...
        <div className={styles.container}>
          <article className={styles.article}>
            <section id="introduction" className={styles.section}>
              ...
              <p>
                The email summary I received from Brook at DX highlighted how these companies are addressing the
                decades-old challenge of measuring developer productivity at scale. In this post, I'm sharing my
                thoughts on these findings and how they align with my own experience building high-performing
                engineering teams.
              </p>
            </section>
            ...
            <section id="evolution" className={styles.section}>
              ...
              <p>
                What struck me most about the panel insights was how the evolution of productivity metrics mirrored my
                own journey as an engineering leader. Many organizations start with what I call "vanity metrics"—lines
                of code, commit volume, or story points—because they're easy to measure, not because they're valuable.
              </p>
              ...
              <p>
                ...
                saved and $2.5M in value mirrors what I've seen at previous companies. When we revamped our CI/CD
                pipeline at a previous role, we saved each developer roughly 45 minutes per day—a number that became
                much more compelling when translated to business impact.
              </p>
            </section>
            ...
            <section id="leadership" className={styles.section}>
              ...
              <p>
                The research described the difference between organizations with engaged executives versus disengaged
                ones as "night and day," which matches my observations. When I've been able to get C-level buy-in for
                developer experience initiatives, the impact has been dramatically higher than when these efforts
                remained isolated within engineering teams.
              </p>
              <p>
            ...
            <section id="genai" className={styles.section}>
              ...
              <p>
                The findings on how leading companies are measuring AI's impact on development are particularly timely.
                In my recent work, I've been exploring AI adoption strategies, and the panel's insights align with my
            ...
            <section id="culture" className={styles.section}>
              ...
              <p>
                ...
                developers work faster" rather than "removing barriers and toil." A simple reframing dramatically
                improved reception.
              </p>
            ...
            <section id="reflection" className={styles.section}>
              ...
              <p>
                Having spent 20 years building engineering cultures across organizations of various sizes, these
                research insights reinforce several principles I've come to value:
              </p>
              <ol>
                <li>
                  <strong>Focus on removing friction, not increasing output.</strong> The most effective way to improve
                  developer productivity is to identify and eliminate barriers—whether technical, procedural, or
                  cultural.
                </li>
                <li>
                  <strong>Connect improvements to business outcomes.</strong> Translating productivity gains into
                  business impact isn't just about justifying investment—it helps align engineering work with company
                  goals.
                </li>
                <li>
                ...
                <li>
                  <strong>Invest in cultural foundations.</strong> The most sophisticated measurement tools won't
                  succeed in a culture of fear or mistrust. Psychological safety must come first.
                </li>
              </ol>
              <p>
                Whether you're leading a small startup team or a large enterprise organization, these principles can
                help you build a more productive, engaged engineering function. Developer productivity isn't about
                working harder or faster—it's about creating an environment where talented engineers can focus on what
                they do best: solving important problems with elegant solutions.
              </p>
              <p>
                As engineering leaders, our most important job isn't measuring productivity but creating the conditions
                where high productivity naturally emerges. By focusing on developer experience rather than output
                metrics, we build stronger teams that deliver better results for our businesses and customers.
              </p>
            </section>
          </article>
