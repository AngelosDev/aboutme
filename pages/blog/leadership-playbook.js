          ...
          <article className={styles.article}>
            <section id="intro" className={styles.section}>
              ...
              <p>
                ...
                style is flexible, adaptive, and deeply rooted in trust and collaboration. Below is a generic plan for
                the first 120 days within a new organization, structured to align with the needs of the business, a
            ...
            <section id="30-days" className={styles.section}>
              ...
              <p>
                I begin by getting to know my team members, both professionally and personally, sharing my own journey
                to create a foundation of trust and authenticity. I don't hesitate to show vulnerability by sharing my
                own strengths and weaknesses. This fosters an environment of openness and mutual respect.
              </p>
              ...
              <p>
                I ask team members to share 2–3 things they would like to see improved, started, or stopped. From this,
                I collaborate with them to set actionable, short-term goals that are achievable within the first 90
                days, helping them build momentum and confidence.
              </p>

              <h3>Product/Service</h3>
              <h4>Business Core Understanding:</h4>
              <p>
                I immerse myself in understanding the product or service at the heart of the business—what drives
                revenue, what opportunities exist, and where the pain points lie.
              </p>
              ...
              <ul>
                ...
                <li>
                  <strong>Stakeholder Engagement:</strong> I create a stakeholder map to ensure I know who to engage
                  with and when, enabling effective communication and alignment across departments.
                </li>
                <li>
              ...
              <ul>
                <li>
                  <strong>Technical Evaluation:</strong> I review the technology stack, past architectural decisions,
                  and technical debt through documentation, ADRs, and changelogs.
                </li>
                <li>
              ...
              <h3>Growth Plan</h3>
              <p>
                I evaluate the growth trajectory, whether it's organic, sales-driven, or product-led, ensuring the team
                is structured and resourced to meet future opportunities and challenges. This includes assessing the
                team's current capacity, skill set, and potential for growth.
              </p>
              ...
              <p>
                ...
                from them to me. This includes identifying key hand-over documents, setup of knowledge transfer
                sessions, and any additional support needed with a target date for completion. This is key for ensuring
                that existing members of the team feel supported and that the team is able to continue to function
            ...
            <section id="90-days" className={styles.section}>
              ...
              <p>
                I work with my direct reports to resolve at least one of their identified pain points, empowering them
                to take ownership while I am on hand to provide guidance and support as needed.
              </p>
              ...
              <p>
                ...
                impact—e.g., a new collaboration tool, a refined retrospective format, or an improved incident
                management process.
              </p>
              ...
              <ul>
                ...
                <li>
                  <strong>Celebrate Wins:</strong> I highlight and celebrate team successes to build momentum and
                  morale.
                </li>
              </ul>
            </section>
            ...
            <section id="120-days" className={styles.section}>
              ...
              <ul>
                <li>
                  <strong>Performance Management:</strong> I evaluate team performance, recognizing high achievers
                  through rewards or promotions, and addressing underperformance constructively.
                </li>
                <li>
              ...
              <p>
                I build a technology roadmap, balancing innovation, scalability, and maintenance, ensuring alignment
                with business goals.
              </p>
            </section>
            ...
            <section id="ongoing" className={styles.section}>
              ...
              <p>
                I promote a culture of continuous learning and improvement, emphasizing reflection and iterative
                progress.
              </p>
            ...
            <section id="delivery" className={styles.section}>
              ...
              <p>
                A robust delivery framework is essential to ensure teams can consistently deliver high-quality,
                impactful work. I focus on fostering an environment where agility and predictability coexist, ensuring
                alignment between engineering efforts and business priorities. Key aspects include:
              </p>
              ...
              <p>
                By instilling a culture of ownership and collaboration, the delivery framework remains flexible enough
                to adapt to changing demands without compromising quality or speed.
              </p>
            </section>
            ...
            <section id="performance" className={styles.section}>
              ...
              <ul>
                <li>
                  <strong>Release Cadence:</strong> Track the frequency and size of deployments to maintain a
                  consistent, predictable flow of value delivery.
                </li>
                <li>
              ...
              <p>
                By consistently evaluating these metrics, I ensure that teams not only deliver value but also operate in
                a sustainable, efficient manner that aligns with business and customer expectations.
              </p>
            </section>
          </article>
